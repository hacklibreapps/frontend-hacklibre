const Error404NotFound = () => {
  return (
    <div className='bg-WhiteBone dark:bg-WhiteBoneDark w-full flex flex-col justify-center items-center h-hacklibre'>
      <div className='text-center'>
        <svg
          ...
          className='enback w-96 sm:w-[500px] h-[400px] text-center fill-PinguinRed7 dark:fill-TechnologyCian5'
          xmlSpace='preserve'
        >
          <g id='Calque_1'>
            <text
          ...
          <g id='Calque_2'>
            <g>
              <path
                className='fill-PinguinRed7 dark:fill-TechnologyCian5'
                id='XMLID_11_'
		...
		c4.4,4.8,10.8,7.8,17.9,7.8c8.3,0,15.6-4.3,19.9-10.7C119.2,54.5,118.6,54.1,118.1,53.7z'
            ...
            <g id='XMLID_6_'>
              <g id='XMLID_18_'>
                <circle
                  className='circle fill-PinguinRed7 dark:fill-TechnologyCian5'
                  cx='100'
                  cy='41'
                  r='1'
                ></circle>
            ...
            <path
              id='XMLID_5_'
              className='st2 fill-PinguinRed7 dark:fill-TechnologyCian5'
  ...
  s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z'
        ...
        <div className='message text-PinguinRed7 dark:text-TechnologyCian5'>
